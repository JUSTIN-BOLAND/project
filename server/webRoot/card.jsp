...
<html>
	...
	<input type="hidden" id="optType" name="optType" value="0">
		<div>
		   <a href="cardAdd.jsp" class="easyui-linkbutton l-btn" group="" id=""><span class="l-btn-left"><span class="l-btn-text">添   加</span></span></a>
		</div>
		<div class="datagrid-view" style="width: 1310.02px; height: 523px;">
	       ...
	       <div class="datagrid-header" style="width: 1284px; height: 25.0104px;">
	           <div class="datagrid-header-inner" style="display: block;">
	              <table class="datagrid-htable" border="0" cellspacing="0" cellpadding="0" style="height: 26px;">
					...
					<td field="NUMS"><div class="datagrid-cell" style="width: 138px; text-align: center;"><span>
						预付余额
					</span><span class="datagrid-sort-icon">&nbsp;</span></div></td>
					<td field="NUMS"><div class="datagrid-cell" style="width: 138px; text-align: center;"><span>
						卡余额
					...
					<div class="datagrid-body" style="width: 1284px; margin-top: 0px; height: 497.021px; overflow-x: hidden;">
					  <table class="datagrid-btable" cellspacing="0" cellpadding="0" border="0">
					     ...
					     try
					     {
					        ...
					        sql="select card_id,reserve_money,ifnull(balance_money,0) balance_money ,DATE_FORMAT(insert_date,'%Y-%m-%d %H:%i:%s') insert_date from t_card";
						...
						%>
						  <tr id="datagrid-row-r1-2-0" datagrid-row-index="0" class="datagrid-row" style="height: 37px;">
					       ...
					       <td field="NUMS"><div style="width: 138px;text-align:center;;white-space:normal;height:auto;" class="datagrid-cell datagrid-cell-c1-NUMS"><%=rs.getString("reserve_money")%></div></td>
					       <td field="NUMS"><div style="width: 138px;text-align:center;;white-space:normal;height:auto;" class="datagrid-cell datagrid-cell-c1-NUMS"><%=rs.getString("balance_money")%></div></td>
					       <td field="NUMS"><div style="width: 138px;text-align:center;;white-space:normal;height:auto;" class="datagrid-cell datagrid-cell-c1-NUMS"><%=rs.getString("insert_date")%></div></td>
					       <td field="NUMS"><div style="width: 138px;text-align:center;;white-space:normal;height:auto;" class="datagrid-cell datagrid-cell-c1-NUMS">
					       
					       <a href="cardAdd.jsp?optType=3&cardId=<%=rs.getString("card_id")%>" class="easyui-linkbutton l-btn" group="" id=""><span class="l-btn-left"><span class="l-btn-text">删   除</span></span></a>
					       </div></td>
					       </tr>
						<%		 
							 }
