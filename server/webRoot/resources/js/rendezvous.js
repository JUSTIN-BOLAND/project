...
(function(scope, root, $) {
	...
	function RendezVousNode(_$node, _settings, _callback) {
		...
		var defaultTemplates = {
			...
			input: {
				default:
					'<input class="%prefix-input-date" id="%inputDateId" name="%inputDateId" type="text"%readonly>',
				split:
					'<input class="%prefix-input-day" id="%inputDateIdDay" name="%inputDateIdDay" type="text"%readonly>'+
					'%inputSeparator'+
					'<input class="%prefix-input-month" id="%inputDateIdMonth" name="%inputDateIdMonth" type="text"%readonly>'+
					'%inputSeparator'+
					'<input class="%prefix-input-year" id="%inputDateIdYear" name="%inputDateIdYear" type="text"%readonly>',
			},
			datepicker:
		...
		var buildTemplate = function(template) {
			...
			for(var i in settings.internationalWeekOrder) {
			  ...
			  var typeName = typeof day;
				//alert("buildTemplate : "+day+" -> "+lb);
		...
		var completeSettings = function(customSettings) {
			...
			input = input.replace("%inputDateId",settings.inputDateId).replace("%inputDateId",settings.inputDateId);
