...
public class ChineseToEnglish {
    ...
    public static final Logger log = Logger.getLogger(ChineseToEnglish.class);
    ...
    public static String getFullSpell(String cnStr) {
        ...
        for (int i = 0, Len = chars.length; i < Len; i++) {
            ...
            log.info("getFullSpell : "+ascii+" : "+chars[i]+" : "+ ((String.valueOf(chars[i])).getBytes()).length);
            if (ascii == 0) { //取ascii时出错
                retuBuf.append(chars[i]);
            }
            else {
                String spell = getSpellByAscii(ascii);
                log.info("getFullSpell : "+ascii+" : "+spell);
                if (spell == null) {
                    retuBuf.append(chars[i]);
                }
                else {
