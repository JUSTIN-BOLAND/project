...
public   class  JSONObjectSample {
	...
	private   static  JSONObject createJSONObject(){
		...
		jsonObject1.put("name" ,  "kevin" );
		jsonObject1.put("Max.score" ,  new  Integer( 100 ));
		jsonObject1.put("Min.score" ,  new  Integer( 50 ));
		jsonObject1.put("nickname" ,  "picglet" );



		JSONObject jsonObject = new  JSONObject();
		jsonObject.put("names" , jsonObject1 );
