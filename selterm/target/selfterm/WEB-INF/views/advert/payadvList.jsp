...
// 					                      max: laydate.now(),
					       ...
					       <select class="grap-sel" name="advplace">
					        ...
					        <input class="grap-btn" type="button" onclick="query('<%=request.getContextPath()%>/advertise/pagePayAdvert.html');"  value="查询"/>
...
<%-- 			       		    </t:buttonOut> --%>
					...
					<!-- 加载初始数据 -->
					<script type="text/javascript">
	 					 var url = '<%=request.getContextPath()%>/advertise/pagePayAdvert.html';
		    			 $("#page_data").load(url);
					</script>
