	...
	<form class="form-add" method="get" accept-charset="utf-8"
		...
		<div class="form-group">
			<label class="form-lal"><i class="text-danger">*</i>用户登录账户：</label> <input
				class="form-txt" type="text" id="orgName" name="loginnmame" value="${userOperator.loginnmame}" disabled="disabled"
		...
		<div class="form-group">
		 <style>input[type='password']{margin-right:10px;}</style>
			<label class="form-lal"><i class="text-danger">*</i>密码：</label> <input type="text" 
				class="form-txt" name="name" id="password" value="${password}" disabled="disabled"/>
		...
		<div class="form-group">
			...
			<input class="form-txt" type="text" value="${roleList.rolename }" disabled="disabled"/>
		</div>
		<%-- <div class="form-group">
			<label class="form-lal"><i class="text-danger">*</i>上级用户：</label> 
						<input  type="text" disabled="disabled" value="${parentuser.name}" class="form-txt"/>
		</div> --%>
