...
public class PayQueryResp {
	...
	@Seq(10)private String end_time;
	...
	public String toString() {
		return "PayQueryResp [return_code=" + return_code + ", return_msg=" + return_msg + ", result_code=" + result_code + ", pay_type=" + pay_type + ", merchant_name=" + merchant_name + ", merchant_no=" + merchant_no + ", terminal_id=" + terminal_id + ", terminal_trace=" + terminal_trace + ", terminal_time=" + terminal_time + ", total_fee=" + total_fee + ", end_time=" + end_time + ", out_trade_no=" + out_trade_no + ", channel_trade_no=" + channel_trade_no + ", user_id=" + user_id + ", attach=" + attach + ", key_sign=" + key_sign + "]";
	}
	/**
	 * @return the channel_trade_no
	 */
	public String getChannel_trade_no() {
		return channel_trade_no;
	}
	/**
	 * @param channel_trade_no the channel_trade_no to set
	 */
