...
public class PrePay {
	...
	/**
	 * 扫码支付接口
	 * @param pay_type (必填)请求类型，“010”微信，“020”支付宝，“060”qq 钱包
	 * @param terminal_trace  (必填)终端流水号 我们的订单
	 * @param operator_id 操作员号 
	 * @param total_fee (必填)金额，单位分
	 * @param order_body 订单描述 
	 * @param notify_url 外部系统通知地址
	 * @param attach 附加数据，原样返回
	 * @throws Exception
	 */
	public PrePay(String pay_type,  String terminal_trace, String operator_id, String total_fee, String order_body, String notify_url, String attach,Date date) throws Exception {
		super();
