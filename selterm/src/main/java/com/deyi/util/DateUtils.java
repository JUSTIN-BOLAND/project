...
public class DateUtils {
	...
	public static void main(String[] args) throws ParseException {
		/*
		 * try { String d = "2016-02-29"; SimpleDateFormat sdf = new
		 * SimpleDateFormat("yyyy-MM-dd"); Date date; date = sdf.parse(d);
		 * 
		 * Date newDate = addDate1(date, 1); SimpleDateFormat dateFormat = new
		 * SimpleDateFormat("yyyy-MM-dd");
		 * System.out.println(dateFormat.format(d));
		 * System.out.println(dateFormat.format(newDate)); } catch
		 * (ParseException e) { // TODO Auto-generated catch block
		 * e.printStackTrace(); }
		 */
		
//		Date date = DateUtils.dataTimeFormat.parse("2017-03-08 17:05:05.5");
//		System.out.println(date);
//
//		DecimalFormat df = new DecimalFormat("0.0");
//		System.out.println(getCurrentDate().split("-")[2]);
//		System.out.println((int) Math.round((double) 200 / 30));
//		System.out.println(df.format(2 + (double) 5 / 8));
//		System.out.println(Double.valueOf(df.format(2 + (double) 5 / 8)));
//		System.out.println(Math.round(Double.valueOf(df.format(2 + (double) 5 / 8)) * 15));
		
		System.out.println(getStartTimeOfDay(getLastDay(getMotch())));
		
		System.out.println(getStartTimeOfDay(getToDay(new Date())));
		
		System.out.println(getStartTimeOfDay(getMotch()));
		System.out.println(DateUtils.convertStrToDate("2018-03-15 17:13:23",DateUtils.YMDHMS));
