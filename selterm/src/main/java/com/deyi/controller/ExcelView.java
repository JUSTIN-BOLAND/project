...
//		dateConverter
		dateConverter.setLenient(Boolean.valueOf(DEFAULT_DATE_PATTERN));
	 ...
	 *            附加内容
	 */
	public ExcelView(String filename, String sheetName, String[] properties, String[] titles, Integer[] widths, Converter[] converters, List data, String[] contents) {
...
//					
							...
							cell.setCellValue(BeanUtils.getProperty(map, properties[i]));
