...
<style type="text/css">
    ...
    .memowidth{width: 43%;}
        ...
        <section class="navigation">
          <span>您当前所在的位置：</span><a  href="#" title="">经销商管理</a>/<i>添加经销商</i>
        </section>
        ...
        <div class="article">
              ...
              <div class="form-group">
                      ...
                      <input class="form-txt form-adv-txt iwidth" type="text" name="dealerId" value="${dealerId}"
                             style="width: 18%;" readonly datatype="*" sucmsg="&nbsp;" nullmsg="不能为空">
                       <span class="form-yz Validform_checktip"></span>
              </div>
              <div class="form-group">
                  <label class="form-lal"><i class="text-danger">*</i>经销商名称：</label>
                  <input class="form-txt form-adv-txt iwidth" type="text" name="dealerName" value=""
                         style="width: 18%;" datatype="*,uniqueDealerName" sucmsg="&nbsp;" nullmsg="不能为空">
                  <span class="form-yz Validform_checktip"></span>
              </div>
              <div class="form-group">
                  <label class="form-lal"><i class="text-danger">*</i>设备序列号：</label>
                  <input class="form-txt form-adv-txt iwidth" type="text" name="series" value=""
                         style="width: 18%;" datatype="serial" sucmsg="&nbsp;" nullmsg="不能为空" errormsg="必须8位数字" >
                  <span class="form-yz Validform_checktip"></span>
              </div>
              <div class="form-group">
                  <label class="form-lal"><i class="text-danger">*</i>经销商账号：</label>
                  <input class="form-txt form-adv-txt iwidth" type="text" name="userId" value=""
              ...
              <div class="form-group">
                  ...
                  <input class="form-txt form-adv-txt iwidth" type="text" name="busLicence" value=""
                         style="width: 25%;" datatype="*" sucmsg="&nbsp;" nullmsg="不能为空" errormsg="请输入营业执照名称">
                  <span class="form-yz Validform_checktip"></span>
              </div>
              <div class="form-group">
                  <label class="form-lal"><i class="text-danger">*</i>营业执照号：</label>
                  <input class="form-txt form-adv-txt iwidth" type="text" name="busLicenceNo" value=""
                         style="width: 18%;" datatype="busLicenceNo" sucmsg="&nbsp;" nullmsg="不能为空" errormsg="请输入15-18字符的营业执照号">
                  <span class="form-yz Validform_checktip"></span>
              </div>
              <div class="form-group">
                  <label class="form-lal"><i class="text-danger">*</i>详细地址：</label>
                  <input class="form-txt form-adv-txt memowidth" type="text" name="address" value=""
                         style="width: 40%;" datatype="*" sucmsg="&nbsp;" nullmsg="不能为空" errormsg="请输入详细地址">
                  <span class="form-yz Validform_checktip"></span>
              </div>
              <div class="form-group">
                  <label class="form-lal"><i class="text-danger">*</i>联系人姓名：</label>
                  <input class="form-txt form-adv-txt iwidth" type="text" name="linkman" value=""
              ...
              <div class="form-group">
                  ...
                  <input class="form-txt form-adv-txt iwidth" type="text" name="email" value=""
                         style="width: 18%;" datatype="e" sucmsg="&nbsp;" nullmsg="不能为空" errormsg="输入的邮箱格式不对">
                  <span class="form-yz Validform_checktip"></span>
              </div>
              <div class="form-group">
                  <label class="form-lal"><i class="text-danger">*</i>联系人手机：</label>
                  <input class="form-txt form-adv-txt iwidth" type="text" name="mobile" value=""
              ...
              <div class="form-group">
                  ...
                  <input class="form-txt form-adv-txt iwidth" type="text" name="singleMaxAmount" value=""
              ...
              <div class="form-group">
                  ...
                  <input class="form-txt form-adv-txt iwidth" type="text" name="dayMaxCount" value=""
              ...
              <div class="form-group">
                  ...
                  <input class="form-txt form-adv-txt iwidth" type="text" name="monthMaxCount" value=""
                         style="width: 18%;" datatype="n" sucmsg="&nbsp;" nullmsg="不能为空" errormsg="请输入数字">
                  <span class="form-yz Validform_checktip"></span>
              </div>
              <div class="form-group">
                  ...
                  <textarea class="form-cont memowidth" name="adWords" value="" rows="4"
                            style="width: 18%;" datatype="*" sucmsg="&nbsp;" nullmsg="不能为空" errormsg="请输入广告词"></textarea>
                  <span class="form-yz Validform_checktip"></span>
              </div>
				<div class="form-group">

                    <label class="form-lal"><i class="text-danger">*</i>Logo：</label>
                    <img id="previewImg" style="z-index:1;min-width:100px;min-height:100px;max-width:500px;max-height:400px;" src="<%=request.getContextPath()%>/man/images/upload.png" >
                    <div style="display:none;">
                        <input id="adlogofile" name="adlogofile"   type="file"   class="file" showPreview="false" showCaption="true" dropZoneEnabled="false" >
                    </div>
					<span class="form-yz Validform_checktip"></span> 
					<input type="hidden" id="adLogo" name="adLogo" datatype="*" sucmsg="&nbsp;" nullmsg="不能为空" errormsg="请选择广告Logo" />
				</div>
       ...
       //表单验证
		    ...
		    $(".form-add").Validform({tiptype:3,
                datatype:{
                    "uniqueDealerName":function(gets,obj,curform,regxp){
                        ...
                        var falg = false;
                        $.ajax({
                            url: '<%=request.getContextPath()%>/dealer/uniqueDealerName.html?dealerName='+gets+'&isUpdate=0',
	      ...
	      function myClose(){
            ...
            function f_addDealer(){
                $.ajax({
                    url: "<%=request.getContextPath()%>/dealer/addDealer.html",
                    type: 'POST',
                    cache: false,
